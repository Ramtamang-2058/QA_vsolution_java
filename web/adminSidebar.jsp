...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="AdminHome" action="AdminHome">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<%=request.getContextPath()%>/admin-question-list">
            <i class="fas fa-question"></i>
            <span>All Questions</span></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="<%=request.getContextPath()%>/adminViewAnswer">
    ...
    <li class="nav-item">
        <a class="nav-link" href="question-list" action="/question-list">
