...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css"><!-- comment --><link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="<%=request.getContextPath()%>/static/css/sb-admin-2.min.css" rel="stylesheet">
    <link href="<%=request.getContextPath()%>/static/css/userprofile.css" rel="stylesheet">
...
<div class="wrapper">
  <div class="profile-card js-profile-card">
    <div class="profile-card__img">
      <img src="<%=request.getContextPath()%>/<c:out value="${usr.profile}" />" alt="profile card">
    </div>

    <div class="profile-card__cnt js-profile-cnt">
      <div class="profile-card__name"><c:out value="${usr.fullname}" /></div>
      <div class="profile-card__txt"> <strong><c:out value="${usr.email}" /></strong></div>
      <div class="profile-card-loc">
        <span class="profile-card-loc__icon">
        </span>

        <span class="profile-card-loc__txt">
          <c:out value="${usr.semester}" />
        </span>
        <span class="profile-card-loc__txt">
          ,<c:out value="${usr.faculty}" />
        </span>
      </div>
...
<svg hidden="hidden">
  <defs>
    ...
    <script src="<%=request.getContextPath()%>/static/js/userprofile.js"></script>
